...
public class SalaryDaoImpl implements SalaryDao {
    ...
    public void saveSalary(Salary salary) {
        ...
        Object[] params = new Object[]{salary.getName(), salary.getBasic(), salary.getEat(), salary.getHouse(), salary.getDuty(), salary.getScot(), salary.getPunishment(), salary.getOther(), salary.getGranttime(), salary.getTotalize()};
        try {
    ...
    public void updateSalary(Salary salary) {
        ...
        Object[] params = new Object[]{salary.getName(), salary.getBasic(), salary.getEat(), salary.getHouse(), salary.getDuty(), salary.getScot(), salary.getPunishment(), salary.getOther(), salary.getGranttime(), salary.getTotalize(), salary.getId()};
        try {
            queryRunner.update(sql, params);
        } catch (SQLException e) {
            e.printStackTrace();
